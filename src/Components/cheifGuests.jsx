  ...
  const chiefGuests = [
    {
      ...
      image: "/assets/images/cheifGuests/Picture1.png",
      socials: {
        facebook: "#",
        twitter: "#",
        google: "#",
    ...
    },
    {
      ...
      image: "/assets/images/cheifGuests/Picture2.png",
      socials: {
        facebook: "#",
        twitter: "#",
        google: "#",
    ...
    },
    {
      ...
      image: "/assets/images/cheifGuests/Picture3.png",
      socials: {
        facebook: "#",
        twitter: "#",
        google: "#",
    ...
    },
    {
      ...
      image: "/assets/images/cheifGuests/Picture4.png",
      socials: {
        facebook: "#",
        twitter: "#",
        google: "#",
    ...
    // },
    {
      ...
      image: "/assets/images/cheifGuests/Picture5.png",
      socials: {
        facebook: "#",
        twitter: "#",
        google: "#",
    ...
    },
    {
      ...
      image: "/assets/images/cheifGuests/Picture6.png",
      socials: {
        facebook: "#",
        twitter: "#",
        google: "#",
    ...
    },
    {
      ...
      image: "/assets/images/cheifGuests/Picture7.png",
      socials: {
        facebook: "#",
        twitter: "#",
        google: "#",
    ...
    },
    {
      ...
      image: "/assets/images/cheifGuests/Picture8.png",
      socials: {
        facebook: "#",
        twitter: "#",
        google: "#",
            ...
            <div className="row align-items-center">
              <div className="col-lg-6">
                <div className="title-content text-lg-start mb-2">
                  ...
                  <h2 className="mb-1">
                    MEET OUR <span className="pink">Cheif Guests <span className="text-black">&</span> Speakers</span>
                  </h2>
                  <p className="m-0">
          ...
          <div className="sepaker-list text-center text-white">
            <div className="row justify-content-center">
              {chiefGuests.map((guest, index) => (
                <div key={index} className="col-6 col-lg-3 col-md-6 col-sm-6 p-2">
